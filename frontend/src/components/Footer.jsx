function Footer() {
  return (
    <footer className="bg-gradient-to-t from-black to-netflix-black text-gray-400 py-8 mt-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          <div>
            <h3 className="text-netflix-red font-bold text-xl mb-4 flex items-center">
              <img 
            ...
            <p className="text-sm leading-relaxed mb-4">Advanced analytics platform for Netflix content strategy and business intelligence.</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="hover:text-netflix-red transition-colors cursor-pointer">React + FastAPI</li>
              <li className="hover:text-netflix-red transition-colors cursor-pointer">Machine Learning</li>
              <li className="hover:text-netflix-red transition-colors cursor-pointer">Data Visualization</li>
              <li className="hover:text-netflix-red transition-colors cursor-pointer">Real-time Analytics</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center hover:text-netflix-red transition-colors">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                </svg>
                <a href="mailto:abhishekgiri1978@gmail.com" className="hover:underline">
                  support@netnova.com
                </a>
              </li>
        ...
        <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            ...
            <a href="#" className="hover:text-netflix-red transition-colors">Terms of Service</a>
            <a href="#" className="hover:text-netflix-red transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
